...
ggplot(data = data, aes(x=ceo_age, y=as.numeric(default))) +
  geom_point(size=2,  shape=20, stroke=2, fill="blue", color="blue") +
...
ggplot(data = data, aes(x=labor_avg_mod, y=as.numeric(default))) +
  geom_point(size=2,  shape=20, stroke=2, fill="blue", color="blue") +
  geom_smooth(method="loess", se=F, colour="black", size=1.5, span=0.9) +
...
write_rds(data,"~/Desktop/BA-Courses/Data_Analysis3/Assignment3/data/clean/bisnode_firms_clean.rds")
